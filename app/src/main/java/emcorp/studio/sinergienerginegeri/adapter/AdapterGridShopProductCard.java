...
public class AdapterGridShopProductCard extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterGridShopProductCard(Context context, List<Produk> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            final Produk p = items.get(position);
            view.title.setText(p.judul);
            view.price.setText(p.harga);
            Tools.displayImageOriginal(ctx, view.image, Constant.PICT_PRODUK_URL+p.foto);
    ...
    private void onMoreButtonClick(final View view, final Produk p) {
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, Produk obj, int pos);
    }

    public interface OnMoreButtonClickListener {
        void onItemClick(View view, Produk obj, MenuItem item);
    }
