...
public class DetailProductActivity extends AppCompatActivity {
    ...
    private TextView tvJudul, tvName, tvDeskripsi, price;
    String from = "";
    String id_donasi = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvJudul.setText(produk.judul);
        tvName.setText(produk.full_name);
        tvDeskripsi.setText(produk.deskripsi);
        price.setText(produk.harga);
        id_donasi = produk.id_produk;
        Tools.displayImageOriginal(getApplicationContext(),image, Constant.PICT_PRODUK_URL+produk.foto);
                        ...
                        try {
                            ...
                            if(success.equals("1")){
                                if(from.equals("donasi")){
                                    startActivity(new Intent(DetailProductActivity.this,ProductActivity.class));
                                }else{
                                    startActivity(new Intent(DetailProductActivity.this,ProductActivity.class));
                                }
                                finish();
